var app = (function () {
    ...
    // (51:8) {#each materials as material (material.id)}
    function create_each_block(key_1, ctx) {
    	...
    	return {
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen(span, "click", stop_propagation(function () {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			thead.innerHTML = `<tr class="svelte-m0f5l7"><th>Material</th> 
            <th>Price</th> 
            <th></th></tr>`;
    			...
    			t8 = text(t8_value);
    			attr(td1, "colspan", "2");
    			attr(tr1, "class", "svelte-m0f5l7");
    			attr(table, "class", "primary svelte-m0f5l7");
    		},
    		m(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(button, "class", "float-right svelte-1e7g5np");
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	/*
    extract detail and type
    */
    	function edit(e) {
    		$$invalidate(0, { id, name, price } = e.detail, id, $$invalidate(1, name), $$invalidate(2, price));
    	}
